...
/**
 * This is the Pawn Class. It is a type of Piece on the Chess Board, and is a subclass of ChessPiece. It is used to keep track of pawns in the game. 
 * 
 */
...
public class Pawn extends ChessPiece {
	...
	public boolean valid(int newFile, int newRank, ChessPiece[][] board) {
		...
		if(pieceColor.equals("black"))
		{
			...
			if(currRank == 6)
			{
				if(newFile == currFile && newRank >= currRank - 2 && newSquare == null)
				{
					return true;
				}
			}
	...
	/**
	 * A static method that undoes the promotion of a Pawn to another ChessPiece
	 * @param board: the game chess board
	 * @param oldfile: the file of the Pawn in question before being promoted
	 * @param oldtrank: the rank of the Pawn in question before being promoted
	 * @param color: the color of the Pawn being promoted
	 */
	...
	/**
	 * This method gives us a string representation of a Pawn object on the chess board
	 * @return a two character string that tells us the color and type of the Pawn piece (a black pawn would be bp)
	 * 
	 */
